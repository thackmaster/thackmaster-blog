...
## Resources
Site generator: [Astro](https://astro.build) (using the [Starlight](https://starlight.astro.build) theme)

Site theme (built on top of Starlight): Starlight Galaxy, [https://frostybee.github.io/starlight-theme-galaxy/](https://frostybee.github.io/starlight-theme-galaxy/)
