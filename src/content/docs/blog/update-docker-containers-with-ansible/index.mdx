...
Focusing my efforts now on my host "optiplex", I was able to get the information back as expected. From there, I then grab the requested container details and save them to the variable "container_info".
