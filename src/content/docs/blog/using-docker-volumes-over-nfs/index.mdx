...
<Aside variant='tip'>While this guide will use examples from a MySQL container when using [Standard Notes](https://standardnotes.com), similar issues have been seen with other containers that were able to be resolved with this method.</Aside>
...
<Aside variant='tip'>Remember that these are the commands for distros that use apt as their package manager (Debian, Ubuntu). You may have to alter your commands and/or package for other package managers.</Aside>
